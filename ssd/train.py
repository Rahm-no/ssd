...
def parse_args(add_help=True):
    ...
    parser.add_argument('--dataset', default='openimages-mlperf',
                        ...
                        help='dataset')
    parser.add_argument('--data-path', default='/datasets/open-images-v6-mlperf', help='dataset')
    parser.add_argument('--image-size', default=[800, 800], nargs=2, type=int,
                        help='Image size for training')
    parser.add_argument('--data-augmentation', default="ssd", help='data augmentation policy')
